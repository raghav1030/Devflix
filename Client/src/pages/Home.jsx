    ...
    <div>
      ...
      <div className="relative mx-auto flex flex-col text-white justify-center max-w-maxContent items-center w-11/12 gap-6   ">
        ...
        <div className="max-w-fit w-[80%]  text-richblack-200 text-lg text-center ">
          <p>
            With our online codung courses, you can learn at your own space,
            from anywhere in this world, and get access to a wealth of resouces,
          ...
          <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
            ...
            <div className="flex flex-col items-start gap-10 lg:w-[40%]">
              <div className=" text-lg ">
                The modern Devflix is the dictates its own terms. Today, to be a
